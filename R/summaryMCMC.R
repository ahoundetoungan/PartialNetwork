...
#' @param x object of class "mcmcSAR", output of the function \code{\link{mcmcSAR}}.
#' @param x object of class "plot.mcmcSAR", output of the function \code{\link{plot.mcmcSAR}}.
