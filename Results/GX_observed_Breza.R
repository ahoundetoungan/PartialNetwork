...
for (x in 1:n.kappa) {
  ...
  save(out.mc, file = "mc.gx_observed_Breza.Rda")
}
...
for (x in 1:n.kappa) {
  write.csv(results[[x]], file = paste0("~/Dropbox/Papers - In progress/Partial Network/Simulations/Monte Carlo/Results/Gx_observed_Breza_kappa=", kappa[x], ".csv"))
}
