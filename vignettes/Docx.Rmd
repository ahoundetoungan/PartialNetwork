...
# save(data.plot1, data.plot2, file = "out.ard.rda")
```
...
# save(out.lspa1, file = "out.lsp.rda")
```
...
## Estimating the SAR model with partial ARD
...
summary(out.lspa2) 
```
```{r Bayesard4b, fig.height = 3, fig.align = "center"}
