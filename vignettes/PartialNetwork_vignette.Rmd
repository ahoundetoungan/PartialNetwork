...
load(url('https://github.com/ahoundetoungan/PartialNetwork/blob/master/datavignettes/smm.RData?raw=true', "rb"))
```
...
save(smm, file = "~/Dropbox/Papers - In progress/Partial Network/Package/AH/PartialNetwork/datavignettes/smm.RData")
```
## How to compute the variance when the network distribution is estimated?
```{r Smmlogitload, echo = FALSE, eval = TRUE, message=FALSE}
load(url('https://github.com/ahoundetoungan/PartialNetwork/blob/master/datavignettes/smmlogit.RData?raw=true', "rb"))
```
...
save(smmlo, file = "~/Dropbox/Papers - In progress/Partial Network/Package/AH/PartialNetwork/datavignettes/smmlogit.RData")
```
...
load(url('https://github.com/ahoundetoungan/PartialNetwork/blob/master/datavignettes/out.none.RData?raw=true', "rb"))
#save(out.none1, out.none2.1, out.none2.2, out.none3.1, out.none3.2, file = "~/Dropbox/Papers - In progress/Partial Network/Package/AH/PartialNetwork/datavignettes/out.none.RData")
```
...
load(url('https://github.com/ahoundetoungan/PartialNetwork/blob/master/datavignettes/out.logi.RData?raw=true', "rb"))
# save(out.logi2.2, out.logi3.2, slogestim, sout.logi4.1, sout.logi4.2, sout.logi4.3, sout.selb1, sout.selb2, file = "~/Dropbox/Papers - In progress/Partial Network/Package/AH/PartialNetwork/datavignettes/out.logi.RData")
```
...
load(url('https://github.com/ahoundetoungan/PartialNetwork/blob/master/datavignettes/out.ard.RData?raw=true', "rb"))
# save(data.plot1, data.plot2, genz, genv, zi, vk, file = "~/Dropbox/Papers - In progress/Partial Network/Package/AH/PartialNetwork/datavignettes/out.ard.RData")
```
...
load(url('https://github.com/ahoundetoungan/PartialNetwork/blob/master/datavignettes/out.lsp.RData?raw=true', "rb"))
#save(out.lspa1, out.lspa2, file = "~/Dropbox/Papers - In progress/Partial Network/Package/AH/PartialNetwork/datavignettes/out.lsp.RData")
```
**We first simulate data.** 
